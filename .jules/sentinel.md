...
## 2025-02-20 - [Critical] LaTeX Injection RCE and DoS
**Vulnerability:** PDF compilation via pdflatex/pandoc allowed shell escape and lacked timeouts, risking RCE and DoS.
**Learning:** Subprocess calls to external engines must always disable shell access and enforce timeouts.
**Prevention:** Use -no-shell-escape and timeout=30 in process.communicate().
