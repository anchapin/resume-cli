...
This library provides a unified interface for generating PDF resumes that can be used by both resume-cli and ResumeAI applications.
...
- **Template Variants**: Support for multiple template styles (base, modern, academic, etc.)
...
# Initialize generator with your templates directory
