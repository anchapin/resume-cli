...
[![CI](https://github.com/anchapin/resume-cli/actions/workflows/ci.yml/badge.svg)](https://github.com/anchapin/resume-cli/actions/workflows/ci.yml)
[![Lint](https://github.com/anchapin/resume-cli/actions/workflows/lint.yml/badge.svg)](https://github.com/anchapin/resume-cli/actions/workflows/lint.yml)
[![Security](https://github.com/anchapin/resume-cli/actions/workflows/security.yml/badge.svg)](https://github.com/anchapin/resume-cli/actions/workflows/security.yml)
...
- **LinkedIn Integration**: Import/export LinkedIn profile data (including full data archive with folder export)
...
Options:
  --data-file PATH     Path to LinkedIn exported JSON, CSV, or folder (required)
...
5. Extract the ZIP file - you can use either:
   - The extracted **folder** directly (contains Profile.csv, Positions.csv, Education.csv, Skills.csv, etc.)
   - A single JSON file (e.g., `profile.json`)
   - A single CSV file (e.g., `Profile.csv`)
...
```bash
# Import from extracted LinkedIn data folder (recommended for full data)
...
```
resume-cli/
├── resume.yaml              # Single source resume data (gitignored - personal data)
├── cli/                     # CLI package
│   ├── main.py              # Entry point
...
├── resume_pdf_lib/          # Shared PDF generation library
...
- ✅ LinkedIn folder-based data archive import
