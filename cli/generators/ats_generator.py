...
# Action verbs cached as tuple to prevent allocation overhead on every function call
_ACTION_VERBS = (
    "developed",
    "implemented",
    "built",
...
class ATSGenerator:
    ...
    def _check_readability(self, resume_data: Dict[str, Any]) -> ATSCategoryScore:
        ...
        # Use module-level tuple to prevent allocation overhead
        # Cache lowered text to avoid repeated str.lower() calls
