...
class ATSGenerator:
    ...
    def _check_readability(self, resume_data: Dict[str, Any]) -> ATSCategoryScore:
        ...
        # ⚡ Bolt: Cache lowercased text outside the loop to prevent O(N) redundant string
        # allocations inside comprehensions.
        all_text_lower = all_text.lower()

        # Check for action verbs in experience bullets
        # ⚡ Bolt: Use pre-defined tuple _ACTION_VERBS for iteration
        ...
        # ⚡ Bolt: Use pre-compiled regex for efficiency
