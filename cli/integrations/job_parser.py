...
_INDEED_TITLE_SUFFIX_PATTERN = re.compile(r"\s*[-|]\s*.*$")
...
_SALARY_CLEAN_PATTERN = re.compile(r"\s+")
    ...
    def _parse_generic(self, html: str) -> JobDetails:
        ...
        if not position:
            ...
            if title_tag:
                ...
                position = _INDEED_TITLE_SUFFIX_PATTERN.sub("", title)
    ...
    def _extract_salary_from_text(self, text: str) -> Optional[str]:
        ...
        for pattern in _SALARY_PATTERNS:
            ...
            if match:
                ...
                salary = _SALARY_CLEAN_PATTERN.sub(" ", salary.strip())
