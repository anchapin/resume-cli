...
class LinkedInSync:
    ...
    def _categorize_skills(self, skills: List[str]) -> Dict[str, List[str]]:
        ...
        patterns = [
            (_LANGUAGES_PATTERN, "languages"),
            (_FRAMEWORKS_PATTERN, "frameworks"),
            (_CLOUD_PATTERN, "cloud_platforms"),
            (_DATABASES_PATTERN, "databases"),
            (_TOOLS_PATTERN, "tools"),
        ]
