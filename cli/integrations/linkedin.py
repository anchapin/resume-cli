...
class LinkedInSync:
    ...
    # Pre-compiled alternated regex patterns for skill categorization
    # This optimization prevents O(N * K) regex overhead when processing multiple skills
    ...
    def _categorize_skills(self, skills: List[str]) -> Dict[str, List[str]]:
        ...
        for skill in skills:
            ...
            for pattern, category in self._CATEGORIES:
