...
class PDFConverter:
    ...
    def _compile_pdflatex(
        ...
        """
        try:
            # 🛡️ Sentinel: Prevent LaTeX Command Injection (RCE) by disabling shell escape
            ...
            try:
                # 🛡️ Sentinel: Prevent DoS from infinite hangs during compilation
                stdout, stderr = process.communicate(timeout=30)
            except subprocess.TimeoutExpired:
                # Cleanup zombie processes on timeout
                process.kill()
