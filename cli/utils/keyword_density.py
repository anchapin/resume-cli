...
# Use a set for O(1) membership checking and to avoid redundant list allocation
_TECH_KEYWORDS = {
    "python",
    "javascript",
    "typescript",
...
class KeywordDensityGenerator:
    ...
    def _extract_job_details(self, job_description: str) -> Tuple[str, str]:
        ...
        # Try to extract job title using pre-compiled patterns
        ...
        # Try to extract company name using pre-compiled patterns
...
Please extract the keywords:"""
    ...
    def _suggest_sections_for_keyword(
        ...
        # Check if keyword is tech-related using module-level set
