...
class ResumeYAML:
    ...
    def get_experience(self, variant: Optional[str] = None) -> list:
        ...
        # Pre-compute lowercased keywords to avoid repetitive allocations inside the nested loops
        ...
        for job in experience:
            ...
            for bullet in bullets:
                ...
                # Cache lowercased text outside comprehension to prevent redundant allocations
