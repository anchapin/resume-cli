...
class TestCLIValidate:
    ...
    def test_validate_valid_resume(self, sample_yaml_file: Path):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "cli.main", "validate", "--yaml-path", str(sample_yaml_file)],
            capture_output=True,
            text=True,
...
class TestCLIVariants:
    ...
    def test_variants_lists_all(self, sample_yaml_file: Path):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "cli.main", "variants", "--yaml-path", str(sample_yaml_file)],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent,
        )
...
class TestCLIErrorHandling:
    ...
    def test_invalid_yaml_path(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "cli.main", "validate", "--yaml-path", "/nonexistent/path.yaml"],
            capture_output=True,
            text=True,
            cwd=Path(__file__).parent.parent,
        )
